...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t2_D1e-05.tex}
\end{table}
...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t4_D1e-05.tex}
\end{table}
...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t5_D1e-05.tex}
\end{table}
