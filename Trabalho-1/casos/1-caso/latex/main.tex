...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t1_D0.1.tex}
\end{table}
...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t2_D0.1.tex}
\end{table}
...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t3_D0.1.tex}
\end{table}
...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t4_D0.1.tex}
\end{table}
...
\begin{table}[H]
    ...
    \input{code/latex/Tabela_Advec_Difus_t5_D0.1.tex}
\end{table}
